    ...
    {   
       try
       {
          conn = DBConnection.getInstance().getConnect();
           ...
           qry = "insert into AddressBook values ('"+person.getName()+"','"+person.getMob()+"','"+person.getEmail()+"','"+person.getCity()+"','"+person.getPincode()+"')";
    ...
    public void getSelectedName(DetailViewPanel detailPanel,String selectedName)
    {
        try {
            ...
            while(rs.next()){
             ...
             System.out.println("in DAO IMple"+ rs.getString("city"));
             System.out.println("in DAO IMple"+ rs.getString("gender"));
